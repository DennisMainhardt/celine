      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground mt-6">
            Eine Auswahl unserer beliebtesten Leistungen.
            Professionelle Pflegedienstleistungen, individuell abgestimmt auf deinen Stil und deine Merkmale.
            Von präzisen Haarschnitten bis hin zur luxuriösen Heißtuch-Rasur – hier erlebst du Barbierhandwerk auf höchstem Niveau.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7">
          {featuredServices.map((service) => (
            <div
              key={service.id}
              className="service-item bg-white rounded-xl p-8 border border-border 
                         transition-all duration-300 flex flex-col h-full shadow-sm 
                         hover:shadow-lg hover:border-secondary hover:-translate-y-1"
            >
              <div className="mb-5 inline-block p-3 rounded-full bg-secondary/10 w-fit">
