...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Ich bin jetzt seit über zwei Jahren bei Celine und ich gehe jedes Mal mit einem Lächeln raus. Celine weiß einfach, was zu mir passt, berät ehrlich und nimmt sich wirklich Zeit. Ich fühle mich jedes Mal wie neu.",
    date: "vor 2 Wochen",
    verified: true
  },
  {
    ...
    rating: 5,
    text: "Ich war etwas nervös wegen einer Veränderung, aber Celine hat mir sofort das Gefühl gegeben, in den besten Händen zu sein. Sie hat nicht einfach drauflosgeschnitten, sondern zugehört, beraten und mich ehrlich begeistert. Ich liebe meinen neuen Look!",
    date: "vor 1 Monat",
    verified: true
  },
  {
      ...
      <div className="container-custom">
        ...
        <div className="mt-16 text-center p-8 bg-white rounded-lg shadow-sm border border-border max-w-3xl mx-auto card-hover">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:+491795256700" className="btn-primary">
              Anrufen: +49 179 5256700
            </a>
          </div>
        </div>
      </div>
