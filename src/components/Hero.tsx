    ...
    >
      ...
      <div className="relative z-10 max-w-3xl animate-fade-in">
        <span className="inline-block px-4 py-1 bg-secondary/20 text-secondary rounded-full text-sm font-medium mb-5">
          Persönliche Beauty- & Stylingmomente – mit Liebe zum Detail.
        </span>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white">
          Dein Look. Dein Moment. Deine <span className="text-secondary">Ausstrahlung</span>.
        </h1>
        <p className="text-lg sm:text-xl text-gray-200 mb-10">
          Bei mir geht es nicht nur um Haare – sondern darum, dass du dich schön, sicher und wohl fühlst.
        </p>
